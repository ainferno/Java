    ...
    ********************************************************************************/
    public static void main(String[] args) {
        ...
        if (args.length == 1) {
            ...
            particles[0] = new Particle(0.5,0.5,0.005,0.005/*0.01 * (Math.random() - 0.5),0.01 * (Math.random() - 0.5)*/,0.05,50,Color.BLACK);
            for (int i = 1; i < N; i++) particles[i] = new Particle(Math.random(),Math.random(),0.01 * (Math.random() - 0.5),0.01 * (Math.random() - 0.5),0.01,0.5,Color.RED);
        }
